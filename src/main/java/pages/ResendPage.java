...
public class ResendPage extends BasePage {
    ...
    public final By SUBMIT_BUTTON = By.xpath(".//*[@class='submit wg-btn wg-btn--navy js-survey-submit']");
    public final By TWITTER = By.xpath(".//*[@class='wg-footer__social-item']//*[contains(@href,'twitter')]");
    public final By SHOW_THANKS = By.xpath(".//*[@class='survey-success'][@style='display: block;']");
